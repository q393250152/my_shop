    ...
    <div class="right">
        <div class="admin-content">
            ...
            <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
                ...
                <li><a href="#" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>会员数<br/>3000</a>
                </li>
            </ul>
                            ...
                            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
                                ...
                                <tr>
                                    <td class="am-text-center"><img
                                                src="{{ asset('amaze/i/examples/admin-chrome.png') }}"
                                                alt=""></td>
                                    <td>Google Chrome</td>
                                    <td>3,005</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img
                                                src="{{ asset('amaze/i/examples/admin-firefox.png') }}"
                                                alt=""></td>
                                    <td>Mozilla Firefox</td>
                                    <td>2,505</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="{{ asset('amaze/i/examples/admin-ie.png') }}"
                                                                    alt=""></td>
                                ...
                                <tr>
                                    <td class="am-text-center"><img
                                                src="{{ asset('amaze/i/examples/admin-opera.png') }}"
                                                alt=""></td>
                                    <td>Opera</td>
                                    <td>4,005</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img
                                                src="{{ asset('amaze/i/examples/admin-safari.png') }}"
                                                alt=""></td>
                                    <td>Safari</td>
                                    <td>505</td>
                                </tr>
