...
//    {
//        Cache::forget('admin_wechat_menus');        //清除缓存
//        $menus = Cache::rememberForever('admin_wechat_menus', function () {
//            $menu = new Menu($this->app_id, $this->secret);
//            return $menu->get();
//        });
//        return view('admin.wechat.index', ["menus" => $menus, '_get_menu' => 'am-active']);
//    }
    //获取菜单
    public function get_menu()
    {
    ...
    function api_config()
    {
        ...
        return view('admin.wechat.config', ['config' => $config, '_api_config' => 'am-active']);
    }
    ...
    function set_config(Request $request)
    {
        ...
        return back()->with('info','接口参数修改成功~');
    }
}